...
cwd = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'tpp-pytorch-extension')
...
sources = [
    "tpp-pytorch-extension/src/csrc/init.cpp",
    "tpp-pytorch-extension/src/csrc/optim.cpp",
    "tpp-pytorch-extension/src/csrc/xsmm.cpp",
    "tpp-pytorch-extension/src/csrc/shm_coll.cpp",
    "tpp-pytorch-extension/src/csrc/common_loops.cpp",
    "tpp-pytorch-extension/src/csrc/qtypes.cpp",
]

# AlphaFold sources
sources += glob.glob("src/distributed_xfold/xsmm_kernels/csrc/*.cpp")
...
setup(
    ...
    version="0.0.1",
    author="Rongshen He",
    author_email="2382713573@qq.com",
    ...
    scripts=["tpp-pytorch-extension/utils/run_dist.sh", 
             "tpp-pytorch-extension/utils/run_dist_ht.sh", 
             "tpp-pytorch-extension/utils/run_dist_numa.sh"],
    libraries=[
